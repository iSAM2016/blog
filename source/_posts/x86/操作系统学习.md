...
1. [学堂在线练习题](https://www.xuetangx.com/courses/TsinghuaX/30240243X/2015_T1/info) 
2. [操作系统\_清华大学文档](https://objectkuan.gitbooks.io/ucore-docs/lab0/lab0_1_goals.html)
# 文章链接
<!--数据结构：TODO: 链表 栈  -->
0. 实验环境搭建
1. 计算机启动过程
