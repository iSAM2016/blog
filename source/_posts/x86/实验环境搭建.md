...
如何向虚拟机传送文件呢，我建议使用scp命令。将虚拟机网络设置为bridged模式。用scp传输文件即可。 
比如我的虚拟机ip 是192.168.9.132，用户名是isam2016

`scp /Users/isam2016/su/os/zhenxianghuanyuan.zip isam2016@192.168.9.132:~`
# Mac安装nasm
`brew install nasm`
# mac 下安装Bochs
