...
2. 将loader.S 写入第二扇区
```
nasm -I include/ -o loader.bin loader.S  && dd if=./loader.bin of=/home/isam2016/opt/bochs/hd60M.img bs=512  count=4 seek=2  conv=notrunc
```

3. mbr编译,写入到虚拟硬盘
```
nasm -I include/ -o mbr.bin mbr.S  && dd if=./mbr.bin of=/home/isam2016/opt/bochs/hd60M.img bs=512 count=1  conv=notrunc
```